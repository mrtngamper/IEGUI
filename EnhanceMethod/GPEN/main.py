...
if __name__=='__main__':
    print("Your image is being processed. This can take a few minutes...", flush=True)
    ...
    parser.add_argument('--task', type=str, default='Segmentation2Face', help='task of GPEN model')
    # parser.add_argument('--model', type=str, default='GPEN-Seg2face-512', help='GPEN model')
    # parser.add_argument('--task', type=str, default='Segmentation2Face', help='task of GPEN model')
    ...
    parser.add_argument('--use_sr', default=True, action='store_true', help='use sr or not')
    ...
    parser.add_argument('--sr_scale', type=int, default=1, help='SR scale')
    ...
    parser.add_argument('--outdir', type=str, default='results/inpainting', help='output folder')
    ...
    for n, file in enumerate(files[:]):
        ...
        # TODO: logger
        if n%1==0: print(n, filename, flush=True)
